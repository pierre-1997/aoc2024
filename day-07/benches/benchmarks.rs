...
pub fn bench_part_1(c: &mut Criterion) {
    ...
    c.bench_function("day_07::part_1", |b| {
        b.iter(|| day_07::part1::process(black_box(input)))
    });
}
...
pub fn bench_part_2(c: &mut Criterion) {
    ...
    c.bench_function("day_07::part_2", |b| {
        b.iter(|| day_07::part2::process(black_box(input)))
    });
}
